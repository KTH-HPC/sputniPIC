...
template <class type>
type *****newArr5(type **in, size_t sz1, size_t sz2, size_t sz3, size_t sz4, size_t sz5)
{
...
//
template < class type > void delArray1(type * arr)
{ delete[](arr); }
template < class type > void delArray2(type ** arr)
{ delArray1(arr[0]); delete[](arr); }
template < class type > void delArray3(type *** arr)
{ delArray2(arr[0]); delete[](arr); }
template < class type > void delArray4(type **** arr)
{ delArray3(arr[0]); delete[](arr); }
//
// versions with dummy dimensions (for backwards compatibility)
//
template <class type> void delArr1(type * arr)
{ delArray1<type>(arr); }
template <class type> void delArr2(type ** arr, size_t sz1)
{ delArray2<type>(arr); }
template <class type> void delArr3(type *** arr, size_t sz1, size_t sz2)
{ delArray3<type>(arr); }
template <class type> void delArr4(type **** arr, size_t sz1, size_t sz2, size_t sz3)
{ delArray4<type>(arr); }
