...
struct interpDens_aux {
    ...
    /** J current densities */
    FPinterp*** Jxh; FPinterp*** Jyh; FPinterp*** Jzh;  // on nodes
...
inline void interp_dens_aux_allocate(struct grid* grd, struct interpDens_aux* id_aux){
...
inline void interp_dens_aux_deallocate(struct grid* grd, struct interpDens_aux* id_aux){
