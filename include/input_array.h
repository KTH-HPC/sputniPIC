...
struct array_int {
  ...
  array_int() {}
  array_int(int u1, int u2, int u3, int u4, int u5, int u6)
...
struct array_double {
  ...
  array_double() {}
  array_double(int u1, int u2, int u3, int u4, int u5, int u6)
      : a(u1), b(u2), c(u3), d(u4), e(u5), f(u6) {}
...
struct array_bool {
  ...
  array_bool() {}
  array_bool(int u1, int u2, int u3, int u4, int u5, int u6)
      : a(u1), b(u2), c(u3), d(u4), e(u5), f(u6) {}
