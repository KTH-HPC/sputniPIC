...
//----------------------------------------------------------------------------
void UpdateVTKAttributes(vtkCPInputDataDescription *idd, FPfield ***Bx,
                         FPfield ***By, FPfield ***Bz, FPinterp ***rhons0_array,
                         FPinterp ***rhons1_array) {
...
//----------------------------------------------------------------------------
void BuildVTKDataStructures(vtkCPInputDataDescription *idd, FPfield ***Bx,
                            FPfield ***By, FPfield ***Bz,
                            FPinterp ***rhons0_array,
                            FPinterp ***rhons1_array) {
  // feed data to grid
...
//----------------------------------------------------------------------------
void CoProcess(double time, unsigned int timeStep, FPfield ***Bx, FPfield ***By,
               FPfield ***Bz, FPinterp ***rhons0_array,
               FPinterp ***rhons1_array) {
