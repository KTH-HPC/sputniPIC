...
void particles_positions_copy_to_device(
    ...
    struct particles_positions_gpu* part_pos, size_t idx_start_gpu,
    size_t idx_end_gpu, size_t idx_start_cpu) {
...
void particles_positions_copy_to_host(cudaStream_t* stream,
                                      ...
                                      size_t idx_start_gpu, size_t idx_end_gpu,
...
int batch_update_particles(cudaStream_t* stream, struct particles* part_cpu,
  ...
  while (offset_cpu < part_cpu->nop) {
    ...
    particles_positions_copy_to_host(stream, part_gpu, part_cpu, offset_gpu,
                                     offset_gpu + current_batch, offset_cpu);
