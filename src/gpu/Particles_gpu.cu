...
void particles_positions_copy_to_device(
    cudaStream_t* stream, struct particles* particles,
    struct particles_positions_gpu* part_pos, size_t idx_start_cpu,
    size_t idx_start_gpu, size_t num_particles) {
...
int batch_update_particles(cudaStream_t* stream, struct particles* part_cpu,
  ...
  while (offset_cpu < part_cpu->nop) {
    ...
    particles_positions_copy_to_device(stream, part_cpu, part_gpu, offset_cpu,
                                       offset_gpu, current_batch);
    ...
    particles_positions_copy_to_host(stream, part_gpu, part_cpu, offset_cpu,
                                     offset_gpu, current_batch);
